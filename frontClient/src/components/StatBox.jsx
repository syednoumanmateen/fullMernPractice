...
const StatBox = ({ title, value, increase, description, icon }) => {
  ...
  return (
    <>
      <Box gridColumn="span 2" gridRow="span 1" display="flex" flexDirection="Column" justifyContent="space-between" p="1.25rem 1rem" flex="1 1 100%"
        backgroundColor={theme.palette.background.alt} borderRadius="0.55rem"
      >
        <FlexBetween>
